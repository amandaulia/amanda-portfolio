...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    kind: "snapshot",
    company: "Wego",
    title: "Hotel Discovery by Point of Interest",
    hook: "Hotel search that answers the question travelers actually ask.",
    role: "Product Manager",
    period: "Sep 2025 — present",
    geo: "Singapore, SG (Remote)",
    category: "Consumer",
    tags: ["Consumer", "Travel", "Discovery"],
    what:
      "Enabled hotel search by point of interest, mapping intent-driven queries (a museum, a beach, a stadium) to relevant inventory with distance- and intent-weighted ranking.",
    outcome: [
      { value: "10%", label: "adoption" },
      { value: "↑", label: "revenue per session" },
    ],
    placeholders: [{ label: "POI search UI + results", caption: "Landmark-driven query → ranked hotel set", h: 320 }],
  },
  {
    slug: "ibm",
    number: "06",
    ...
    hook: "3 hours of analyst research, compressed into minutes.",
    role: "MBA Product Manager (project-based)",
    period: "Aug — Dec 2023",
    geo: "New York, USA",
    category: "Enterprise · AI",
    tags: ["Enterprise", "AI/ML", "GenAI"],
    what: "Built a summarization + RAG proof-of-concept on IBM watsonx, then translated it into a watsonx Playbook used in IBM SkillsBuild.",
    outcome: [
      { value: "3 hrs/day", label: "saved" },
      { value: "2M", label: "students reached via SkillsBuild" },
    ],
    placeholders: [{ label: "watsonx UI + SkillsBuild playbook cover", caption: "PoC and the materials that scaled it", h: 320 }],
  },
  {
    slug: "undp",
    number: "07",
    kind: "snapshot",
    company: "UNDP",
    title: "Digitalizing M&E Tool for Indigenous People & Local Communities Projects",
    hook: "Streamlining monitoring and evaluation for 174 projects and 36 countries.",
    role: "Digital Solutions & M&E Officer",
    period: "Feb 2024 — Jul 2025",
    geo: "New York, USA (Remote)",
    category: "Impact",
    tags: ["Impact", "Digitalization", "ML"],
    what: "The old M&E tool is manually inputted through hundreds of Excel sheets making it difficult to process and analyze. To solve it, the tool is digitalized into a properly formatted form with advanced logic so 174 projects from 36 countries can be monitored and evaluated at scale.",
    outcome: [{ value: "↑", label: "grant-making performance across regions" }],
    placeholders: [{ label: "M&E dashboard + project map", caption: "Operational tooling for distributed teams", h: 320 }],
  },
  {
    slug: "flip",
    number: "08",
    kind: "snapshot",
    company: "Flip",
    title: "Initiating International Transfers for Business Users",
    hook: "Evaluating and proposing the development of a product that is supporting 300+ clients and increasing potential ARPU.",
    role: "Junior Product Manager",
    period: "Feb — Jul 2021",
    geo: "Jakarta, ID (Remote)",
    category: "Fintech",
    tags: ["Fintech", "B2B", "Launch"],
    what: "Initiated the evaluation and development of international transfer product for business users with sales, business, legal, and engineering team. After leaving the company it is reported that it gains a 20% increase in ARPU for business users from this product.",
    outcome: [
      { value: "+20%", label: "revenue" },
      { value: "+18%", label: "active user conversion" },
    ],
    placeholders: [{ label: "International transfer product UI", caption: "B2B onboarding + transfer flow", h: 320 }],
  },
];
